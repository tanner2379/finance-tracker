...
User.create(email: "user4@example.com", password: "password")
User.create(email: "user5@example.com", password: "password")
User.create(email: "user6@example.com", password: "password")
